...
var CreateUser_1 = __importDefault(require("./Pages/CreateUser/CreateUser"));
var NavBar_1 = __importDefault(require("./components/NavBar/NavBar"));
var createDateAndTimeString_1 = __importDefault(require("./components/util/functions/createDateAndTimeString"));
require("./App.css");
        ...
        <div className={classes.appMain}>
          <react_router_dom_1.Switch>
            <react_router_dom_1.Route exact path="/">
              <Users_1.default userData={userData} removeUser={removeUser} submitEditedUser={editUser} fetchUserData={fetchUserData}/>
            </react_router_dom_1.Route>
            <react_router_dom_1.Route path="/create-user">
              <CreateUser_1.default submitUser={createUser}/>
            </react_router_dom_1.Route>
          </react_router_dom_1.Switch>
        </div>
      </div>
